...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServerContacts.ascx.cs" Inherits="MAPPS.CONTROLTEMPLATES.ServerContacts" %>
            ...
            <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Primary">
                        <ItemTemplate>
                            <asp:Label ID="lblPrimary" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.IsPrimary") %>' />
                        </ItemTemplate>
...
<table id="tblItem" runat="server" visible="false" class="ms-formtable" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0" width="50%">
    ...
    <tr>
        <td nowrap="true" valign="top" width="10px" class="ms-formlabel">
            <h3 class="ms-standardheader">User Name
                        <asp:Label ID="lblUserNameRequired" runat="server" CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
            </h3>
        </td>
        <td valign="middle" width="350px" class="snapps-formbody">
            <asp:DropDownList ID="ddlUserName" runat="server" CssClass="ms-long" />
    ...
    <tr>
        <td nowrap="true" valign="top" width="10px" class="ms-formlabel">
            <h3 class="ms-standardheader">Primary
            </h3>
        </td>
        <td valign="middle" width="350px" class="snapps-formbody">
            <asp:CheckBox ID="cbPrimary" runat="server" CssClass="ms-long"  />
            <asp:Label ID="lblPrimaryView" runat="server" CssClass="mapps-item" />
        </td>
    </tr>
     <tr>
