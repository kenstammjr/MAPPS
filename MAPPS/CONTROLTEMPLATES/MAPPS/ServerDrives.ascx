...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServerDrives.ascx.cs" Inherits="MAPPS.CONTROLTEMPLATES.ServerDrives" %>
...
<table id="tblItem" runat="server" visible="false" class="ms-formtable" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0" width="50%">
    ...
    <tr>
        <td nowrap="true" valign="top" width="10px" class="ms-formlabel">
            <h3 class="ms-standardheader">Name
                        <asp:Label ID="lblNameRequired" runat="server" CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
            </h3>
        </td>
    ...
    <tr>
        <td nowrap="true" valign="top" width="10px" class="ms-formlabel">
            <h3 class="ms-standardheader">Size
                        <asp:Label ID="lblSizeRequired" runat="server" CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
            </h3>
        </td>
        <td valign="middle" width="350px" class="snapps-formbody">
            <asp:TextBox ID="txtSize" runat="server" CssClass="ms-long" Width="75" MaxLength="15" />
            <asp:Label ID="lblSizeView" runat="server" CssClass="mapps-item" />
        </td>
    </tr>
    <%--Description--%>
    <tr>
