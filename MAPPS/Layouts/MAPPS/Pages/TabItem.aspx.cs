...
namespace MAPPS.Pages {
    public partial class TabItem : PageBase {
        protected const string PAGE_TITLE = "Tab Details";
        protected const string PAGE_DESCRIPTION = "View and manage Tab details";
        public const string PAGE_URL = BASE_PAGES_URL + "TabItem.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e) {
            try {
                ...
                jsActionCancel = string.Format("rbnCancelClick('{0}/{1}'); return false;", SPContext.Current.Web.Url, Pages.Tabs.PAGE_URL);
                itemRedirect = string.Format("{0}/{1}", SPContext.Current.Web.Url, Pages.Tabs.PAGE_URL);
                newItemRedirect = string.Format("{0}/{1}?View=New&id={2}", SPContext.Current.Web.Url, Pages.TabItem.PAGE_URL, 0);
        ...
        public virtual string GetItemsURL(bool AsLink) {
            ...
            try {
                ...
                s = (AsLink) ? string.Format("<a href=\"{0}\" class=\"mapps-breadcrumb\">Tabs</a>", itemRedirect) : itemRedirect;
            } catch (Exception ex) {
                MAPPS.Error.WriteError(ex);
            }
            return s;
        ...
        private void SetupContribute() {
            ...
            if (IsManager) {
                item = (ItemID == 0) ? new Tab() : new Tab(ItemID);
            } else {
        ...
        protected override void Fill() {
            try {
                ...
                cbAdminOnly.Checked = item.AdminOnly;
                cbAdminOnly.Visible = !isView;
                lblAdminOnlyView.Text = item.AdminOnly ? "Yes" : "No";
                lblAdminOnlyView.Visible = isView;
        ...
        private bool SaveItem() {
            ...
            try {
                ...
                item = (isUpdate) ? new MAPPS.Tab(ItemID) : new MAPPS.Tab();
                ...
                item.AdminOnly = cbAdminOnly.Checked;
        ...
        private bool DeleteItem() {
            bool success = false;
            try {
                MAPPS.Tab item = new MAPPS.Tab(ItemID);
                if (item.Delete()) {
                    success = true;
                    ItemID = 0;
                } else {
        ...
        protected void lbtnEdit_Click(object sender, EventArgs e) {
            Response.Redirect(string.Format("{0}/{1}?View=Edit&id={2}", SPContext.Current.Web.Url, Pages.TabItem.PAGE_URL, ItemID), false);
        }

        protected void lbtnView_Click(object sender, EventArgs e) {
            Response.Redirect(string.Format("{0}/{1}?View=View&id={2}", SPContext.Current.Web.Url, Pages.TabItem.PAGE_URL, ItemID), false);
        }
