...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transactions.aspx.cs" Inherits="MAPPS.Pages.Transactions" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                <td class="mapps-grid-top-full" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Transactions" ForeColor="White"></asp:HyperLink></td>
            </tr>
                    ...
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Category&nbsp;">
                                ...
                                <ItemStyle CssClass="mapps-grid-text-top" HorizontalAlign="Left" Wrap="false" VerticalAlign="Top" />
                            </asp:TemplateField>
                            <%-- Type --%>
                            <asp:TemplateField HeaderText="Type">
                                ...
                                <HeaderStyle CssClass="mapps-grid-header-left" />
                                <ItemStyle CssClass="mapps-grid-text-top" HorizontalAlign="Left" VerticalAlign="Top" />
                            </asp:TemplateField>
                            <%-- Action --%>
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:Label ID="lblAction" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.Action") %>' />
                                </ItemTemplate>
                                <HeaderStyle CssClass="mapps-grid-header-left" />
                                <ItemStyle CssClass="mapps-grid-text-top" HorizontalAlign="Left" VerticalAlign="Top" />
                            </asp:TemplateField>                        
                            ...
                            <asp:TemplateField HeaderText="Action by">
                                ...
                                <HeaderStyle CssClass="mapps-grid-header-left" />
                                <ItemStyle CssClass="mapps-grid-text-top" HorizontalAlign="Left" VerticalAlign="Top" Wrap="false" />
                            </asp:TemplateField> 
                            <%-- CreatedOn --%>
