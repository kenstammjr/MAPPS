...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerEnvironments.aspx.cs" Inherits="MAPPS.Pages.ServerEnvironments" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 5px;">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Server Environments" ForeColor="White"></asp:HyperLink></td>
