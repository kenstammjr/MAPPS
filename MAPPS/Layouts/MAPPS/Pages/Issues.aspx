...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Issues.aspx.cs" Inherits="MAPPS.Pages.Issues" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 5px;">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Project Issues" ForeColor="White"></asp:HyperLink></td>
                    ...
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Issue&nbsp;" >
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnIssue" runat="server" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.ID") %>'
                                        CommandName="ViewItem" Text='<%# DataBinder.Eval(Container,"DataItem.Issue") %>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="ActionTaken" >
                                <ItemTemplate>
                                    <asp:Label ID="lblActionTaken" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.ActionTaken") %>' />
                                </ItemTemplate>
                                <HeaderStyle CssClass="mapps-grid-header-left" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Left" Wrap="false" Width="5px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="TicketNumber">
                                <ItemTemplate>
                                    <asp:Label ID="lblTicketNumber" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.TicketNumber") %>' />
