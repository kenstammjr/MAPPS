...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationItem.aspx.cs" Inherits="MAPPS.Pages.ApplicationItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
    ...
    <div style="width: 40%; float: left;">
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td valign="middle" width="250px" class="mapps-formbody">
            ...
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Is Active
                    </h3>
                </td>
                <td valign="middle" width="350px" class="mapps-formbody">
                    <asp:CheckBox ID="cbIsActive" runat="server" CssClass="ms-input"/>
                    <asp:Label ID="lblIsActiveView" runat="server" CssClass="mapps-item" />
                </td>
            </tr>
            <tr>
