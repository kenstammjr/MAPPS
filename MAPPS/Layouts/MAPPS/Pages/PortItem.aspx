...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortItem.aspx.cs" Inherits="MAPPS.Pages.PortItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
            ...
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Protocol
                        <asp:Label ID="lblProtocolRequired" runat="server"
                            CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
                    </h3>
                </td>
                <td valign="middle" width="350px" class="mapps-formbody">
                    <asp:Textbox ID="txtProtocol" runat="server" MaxLength="15" />
                    <asp:RequiredFieldValidator ID="rfvProtocol" runat="server"
                        ControlToValidate="txtProtocol"
                        ErrorMessage="<br/>You can't leave this blank."
                        InitialValue="0"
                        Display="Dynamic"
                        ForeColor="Red" />
            ...
            <tr>
                ...
                <td valign="middle" width="550px" class="mapps-formbody">
                    <asp:TextBox ID="txtDescription" runat="server" CssClass="ms-input"
                        MaxLength="2000" Width="650" TextMode="MultiLine" Rows="6" />
