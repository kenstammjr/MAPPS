...
namespace MAPPS.Pages {
    public partial class Menus : PageBase {
        protected const string PAGE_TITLE = "Menus";
        protected const string PAGE_DESCRIPTION = "View and manage menus";
        public const string PAGE_URL = BASE_PAGES_URL + "Menus.aspx";
        ...
        private void SetupContribute() {
            if (IsManager) {
                jsActionNewItem = string.Format("window.location.replace('{0}/{1}?View=New&ID=0'); return false;", SPContext.Current.Web.Url, MenuItem.PAGE_URL);
        ...
        protected override void Fill() {
            try {
                ...
                DataView dv = new DataView(Menu.Items().Tables[0]);
            ...
            if (e.CommandName != "Sort" && e.CommandName != "Page") {
                try {
                    if (e.CommandName == "ViewItem") {
                        ...
                        Response.Redirect(string.Format("{0}/{1}?MenuID={2}", SPContext.Current.Web.Url, MenuNodes.PAGE_URL, ItemID), false);
                    }
                    if (e.CommandName == "EditItem") {
                        ItemID = int.Parse(e.CommandArgument.ToString());
                        Response.Redirect(string.Format("{0}/{1}?View=Edit&ID={2}", SPContext.Current.Web.Url, MenuItem.PAGE_URL, ItemID), false);
                    }
        ...
        protected void lbtnNew_Click(object sender, EventArgs e) {
            Response.Redirect(string.Format("{0}/{1}?View=New&id={2}", SPContext.Current.Web.Url, Pages.MenuItem.PAGE_URL, 0), false);
        }
