...
namespace MAPPS.Pages {
    public partial class Transactions : PageBase {
        protected const string PAGE_TITLE = "Transactions";
        protected const string PAGE_DESCRIPTION = "View application transactions";
        public const string PAGE_URL = BASE_PAGES_URL + "Transactions.aspx";
        ...
        protected override void Fill() {
            try {
                gvData.EmptyDataText = "No transactions has been recored.";
                DataView dv = new DataView(Transaction.Items().Tables[0]);
