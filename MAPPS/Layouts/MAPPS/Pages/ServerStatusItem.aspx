...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerStatusItem.aspx.cs" Inherits="MAPPS.Pages.ServerStatusItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Server Status" ForeColor="White"></asp:HyperLink></td>
