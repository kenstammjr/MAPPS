...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerTypeItem.aspx.cs" Inherits="MAPPS.Pages.ServerTypeItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Server Type" ForeColor="White"></asp:HyperLink></td>
