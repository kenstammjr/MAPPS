...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modules.aspx.cs" Inherits="MAPPS.Pages.Modules" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
            ...
            <tr id="trListView" runat="server">
                <td>
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        AllowPaging="true" PageSize="30" OnPageIndexChanging="gvData_PageIndexChanging">
