...
namespace MAPPS.Pages {
    public partial class OpsHome : PageBase {

        protected const string PAGE_TITLE = "Ops Scheduler";
        protected const string PAGE_DESCRIPTION = "MAPPS Operations Schedule";
        public const string PAGE_URL = BASE_PAGES_URL + "OpsHome.aspx";
