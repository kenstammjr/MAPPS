...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectItem.aspx.cs" Inherits="MAPPS.Pages.ProjectItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Project
