...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Applications.aspx.cs" Inherits="MAPPS.Pages.Applications" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 5px;">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Applications" ForeColor="White"></asp:HyperLink></td>
                    ...
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                <ItemTemplate>
                                    <asp:Label ID="lblDescriptionIndex" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.Description") %>' />
                                    </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Protected" >
                                <ItemTemplate>
                                    <asp:Label ID="lblProtected" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.IsProtected") %>' />
                                    <asp:Label ID="lblItemID" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.ID") %>' Visible="False" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="mapps-grid-header-center-end" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Center" />
                            </asp:TemplateField>
                        </Columns>
