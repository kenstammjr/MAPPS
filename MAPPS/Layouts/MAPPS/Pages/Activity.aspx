...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Activity.aspx.cs" Inherits="MAPPS.Pages.Activity" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                <td class="mapps-grid-top-full" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Activity" ForeColor="White"></asp:HyperLink></td>
            </tr>
