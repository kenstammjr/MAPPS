...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menus.aspx.cs" Inherits="MAPPS.Pages.Menus" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
                ...
                <td colspan="2">
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <%-- Visible --%>
                            <asp:TemplateField HeaderText="Visible" SortExpression="IsVisible">
                                <ItemTemplate>
                                    <asp:Label ID="lblVisible" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.IsVisible") %>' />
