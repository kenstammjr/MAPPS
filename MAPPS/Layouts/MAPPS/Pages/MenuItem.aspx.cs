...
namespace MAPPS.Pages {
    public partial class MenuItem : PageBase {
        protected const string PAGE_TITLE = "Menu Item Details";
        protected const string PAGE_DESCRIPTION = "View and manage menu item details";
        public const string PAGE_URL = BASE_PAGES_URL + "MenuItem.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e) {
            try {
                ...
                jsActionCancel = string.Format("rbnCancelClick('{0}/{1}'); return false;", SPContext.Current.Web.Url, Pages.Menus.PAGE_URL);
                itemRedirect = string.Format("{0}/{1}", SPContext.Current.Web.Url, Pages.Menus.PAGE_URL);
                newItemRedirect = string.Format("{0}/{1}?View=New&id={2}", SPContext.Current.Web.Url, Pages.MenuItem.PAGE_URL, 0);
        ...
        public virtual string GetItemsURL(bool AsLink) {
            ...
            try {
                ...
                s = (AsLink) ? string.Format("<a href=\"{0}\" class=\"mapps-breadcrumb\">Menus</a>", itemRedirect) : itemRedirect;
            } catch (Exception ex) {
                MAPPS.Error.WriteError(ex);
            }
            return s;
        ...
        private void SetupContribute() {
            ...
            if (IsManager) {
                item = (ItemID == 0) ? new Menu() : new Menu(ItemID);
            } else {
        ...
        private bool SaveItem() {
            ...
            try {
                ...
                item = (isUpdate) ? new Menu(ItemID) : new Menu();
                item.Name = txtName.Text.Trim();
                item.Description = string.Format(txtDescription.Text.Trim());
        ...
        protected void lbtnEdit_Click(object sender, EventArgs e) {
            Response.Redirect(string.Format("{0}/{1}?View=Edit&id={2}", SPContext.Current.Web.Url, Pages.MenuItem.PAGE_URL, ItemID), false);
        }

        protected void lbtnView_Click(object sender, EventArgs e) {
            Response.Redirect(string.Format("{0}/{1}?View=View&id={2}", SPContext.Current.Web.Url, Pages.MenuItem.PAGE_URL, ItemID), false);
        }
