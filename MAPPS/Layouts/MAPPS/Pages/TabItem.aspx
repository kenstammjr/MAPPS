...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TabItem.aspx.cs" Inherits="MAPPS.Pages.TabItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Tab" ForeColor="White"></asp:HyperLink></td>
...
<asp:Content ID="LeftNavBar" ContentPlaceHolderID="PlaceHolderLeftNavBar" runat="server">
     <asp:PlaceHolder ID="PlaceHolderLeftNavBar" runat="server">
         <a href="TabItem.aspx">TabItem.aspx</a>
     </asp:PlaceHolder>
</asp:Content>
