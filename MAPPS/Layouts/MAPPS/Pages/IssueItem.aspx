...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueItem.aspx.cs" Inherits="MAPPS.Pages.IssueItem" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table class="ms-formtable" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Issue
                        <asp:Label ID="lblIssueRequired" runat="server"
                            CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
                    </h3>
                </td>
                <td valign="middle" width="350px" class="mapps-formbody">
                    <asp:TextBox ID="txtIssue" runat="server" CssClass="ms-input" MaxLength="2000" TextMode="MultiLine" Rows="6" />
                    <asp:RequiredFieldValidator ID="rfvIssue" runat="server"
                        ControlToValidate="txtIssue"
                        ErrorMessage="<br/>You can't leave this blank."
                        Display="Dynamic"
                        ForeColor="Red" />
                    <asp:Label ID="lblIssueView" runat="server" CssClass="mapps-item" />
                </td>
            </tr>
            <%--ActionTaken--%>
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Action Taken
                        <asp:Label ID="lblActionTakenRequired" runat="server"
                            CssClass="ms-formvalidation" Text="*" ToolTip="This is a required field." />
                    </h3>
                </td>
                <td valign="middle" width="350px" class="mapps-formbody">
                    <asp:Textbox ID="txtActionTaken" runat="server" MaxLength="2000" TextMode="MultiLine" Rows="6" />
                    <asp:RequiredFieldValidator ID="rfvActionTaken" runat="server"
                        ControlToValidate="txtActionTaken"
                        ErrorMessage="<br/>You can't leave this blank."
                        InitialValue="0"
                        Display="Dynamic"
                        ForeColor="Red" />
                    <asp:Label ID="lblActionTakenView" runat="server" CssClass="mapps-item" />
                </td>
            </tr>
            <%--TicketNumber--%>
            <tr>
                <td nowrap="true" valign="top" width="113px" class="ms-formlabel">
                    <h3 class="ms-standardheader">Ticket Number
                    </h3>
                </td>
                <td valign="middle" width="550px" class="mapps-formbody">
                    <asp:TextBox ID="txtTicketNumber" runat="server" CssClass="ms-input"
                        MaxLength="2000" Width="50" />
                    <asp:Label ID="lblTicketNumberView" runat="server" CssClass="mapps-item" />
                </td>
            </tr>
