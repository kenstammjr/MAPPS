...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="MAPPS.Pages.Settings" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Application Settings" ForeColor="White"></asp:HyperLink></td>
                            ...
                            <asp:TemplateField HeaderText="Name&nbsp;" SortExpression="Name">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnName" runat="server" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.ID") %>'
                                        CommandName="ViewItem" Text='<%# DataBinder.Eval(Container,"DataItem.Key") %>' />
                                </ItemTemplate>
