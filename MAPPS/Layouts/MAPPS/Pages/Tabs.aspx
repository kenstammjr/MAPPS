...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tabs.aspx.cs" Inherits="MAPPS.Pages.Tabs" MasterPageFile="/_layouts/15/mapps/masterpages/app.master" %>
        ...
        <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 5px;">
            <tr>
                <td class="mapps-grid-top-left" style="text-align: left;">
                    <asp:HyperLink ID="lnkTitle" runat="server" Text="Tabs" ForeColor="White"></asp:HyperLink></td>
                    ...
                    <SharePoint:SPGridView ID="gvData" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description">
                                ...
                                <HeaderStyle CssClass="mapps-grid-header-left" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Left" Width="250px" />
                            </asp:TemplateField>
                            <%-- URL --%>
                            ...
                            <%-- DisplayIndex --%>
                            <asp:TemplateField HeaderText="Display<br>Index" SortExpression="DisplayIndex">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibtnUp" runat="server" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.ID") %>'
                                        CommandName="MoveUp" ToolTip="Move Up" ImageUrl="~/_layouts/15/Images/ARRUPA.GIF" />
                                    <asp:Label ID="lblDisplayIndex" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.DisplayIndex") %>' />
                                    <asp:ImageButton ID="ibtnDown" runat="server" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.ID") %>'
                                        CommandName="MoveDown" ToolTip="Move Down" ImageUrl="~/_layouts/15/Images/ARRDOWNA.GIF" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="mapps-grid-header-center" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Center" Wrap="false" />
                            </asp:TemplateField>
                            <%-- Active --%>
                            <asp:TemplateField HeaderText="Active" SortExpression="IsActive">
                                ...
                                <HeaderStyle CssClass="mapps-grid-header-center" HorizontalAlign="Center" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <%-- AdminOnly --%>
                            <asp:TemplateField HeaderText="AdminOnly" SortExpression="AdminOnly">
                                <ItemTemplate>
                                    <asp:Label ID="lblAdminOnly" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.AdminOnly") %>' />
                                    <asp:Label ID="lblItemID" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.ID") %>' Visible="False" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="mapps-grid-header-center-end" HorizontalAlign="Center" />
                                <ItemStyle CssClass="mapps-grid-text" HorizontalAlign="Center" />
                            </asp:TemplateField>
                        </Columns>
