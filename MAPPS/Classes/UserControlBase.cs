        ...
        protected virtual void AddTabEvents() {
            try {
                ...
                methodInfo.Invoke(manager, new object[] {
                    Page, "InitPageComponent", "/_layouts/15/nga/scripts/PageComponent.js", false, "MAPPS.PageComponent.initialize()"
                });
                    ...
                    if (Page.IsPostBack) {
                        ...
                        if (field.SortExpression == GridSortExpression) {
                            ...
                            if (GridSortDirection == SortDirection.Descending) {
                                sortImage.ImageUrl = "/_layouts/Images/nga/rsort.gif";
                                sortImage.ToolTip = "Sort Descending";
                            } else {
                                sortImage.ImageUrl = "/_layouts/Images/nga/sort.gif";
