    ...
    public class ServerStatus {
        ...
        public ServerStatus(int ID)
            ...
            using (new Impersonator()) {
                ...
                string sql = "SELECT * FROM dbo.ServerStatuses WHERE ID = @ID";
        ...
        public bool Insert() {
            ...
            using (new Impersonator()) {
                ...
                try {
                    ...
                    string sql = @"INSERT INTO dbo.ServerStatuses 
			                                (Name,
										Description,
										CreatedOn,
										CreatedBy,
        ...
        public bool Update() {
            ...
            using (new Impersonator()) {
                ...
                try {
                    DateTime TimeStamp = DateTime.UtcNow;
                    string sql = @"UPDATE dbo.ServerStatuses 
			                        SET Name = @Name,
        ...
        public bool Delete() {
            ...
            using (new Impersonator()) {
                SqlConnection conn = DataSource.Conn();
                try {
                    string sql = "DELETE FROM dbo.ServerStatuses WHERE ID = @ID";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.Parameters.AddWithValue("@ID", _ID);
                    if (conn.State != ConnectionState.Open) { conn.Open(); }
                    cmd.ExecuteNonQuery();
        ...
        public static DataSet Items() {
            ...
            using (new Impersonator()) {
                SqlConnection conn = DataSource.Conn();
                try {
                    string sql = "SELECT * FROM dbo.ServerStatuses order by name";
                    SqlCommand cmd = new SqlCommand(sql, conn);
